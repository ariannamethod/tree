...
class TreeEmbedding:
    ...
    def suggest_next(self, prev_token: str, candidates: List[str]) -> List[str]:
        ...
        logger.debug(f"Suggesting next tokens for '{prev_token}' from {len(candidates)} candidates")
        ...
        for candidate in candidates:
            ...
            cooccurrence_score = self._cooccurrence_counts[prev_normalized][candidate_normalized]
    ...
    def get_embedding_stats(self) -> Dict:
        ...
        return {
            ...
            'total_cooccurrences': sum(len(counts) for counts in self._cooccurrence_counts.values()),
